...
namespace ax25
{
    public class AFSK1200Demodulator
    {
        ...
        private ax25kiss.Packet packet; // received packet
        private ax25kiss.PacketHandler handler = null;
        ...
        public ax25kiss.PacketHandler OnPacket
        {
            set
            {
                this.handler = value;
        ...
        public AFSK1200Demodulator(int sample_rate, int filter_length, ax25kiss.PacketHandler h)
        {
        ...
        public AFSK1200Demodulator(int sample_rate, int filter_length, int emphasis, ax25kiss.PacketHandler h)
        {
            this.Init(sample_rate, filter_length, emphasis, h);
        }

        private void Init(int sample_rate, int filter_length, int emphasis, ax25kiss.PacketHandler h)
        {

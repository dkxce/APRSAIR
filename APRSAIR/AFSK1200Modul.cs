...
namespace ax25
{
    public class AFSK1200Modulator
    {
        ...
        private void prepareToTransmit(ax25kiss.Packet p)
        {
            if (tx_state != TxState.IDLE)
            {
                if (ConsoleOut)
        ...
        public void GetSamples(ax25kiss.Packet p, out double[] _samples)
        {
            _samples = null;
        ...
        public void GetSamples(ax25kiss.Packet p, out float[] _samples)
        {
            _samples = null;

...
@rem 
@rem 
@APRSAIR.exe /kiss /source=127.0.0.1:8100 /!send="http://127.0.0.1/?user={ID}&lat={LAT}&lon={LON}&alt={ALT}" /!aprs="tcp://CTAKAH:12469@127.0.0.1:12015/" /!aprs="udp://UNKNOWN:-1@russia.aprs2.net:8080/" /httpserv=80 /aprsserv=14580 /serverName="My APRSAIR"
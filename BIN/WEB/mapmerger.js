// author: dkxce@mail.ru //
		...
		MapMerger.prototype.GetMap = function(lat, lon, zoom)
		{
			...
			// place icon //
			var smbl = this.SymbolToImage(this.iconSymbol);
			var title = "Icon";
			ddv += '<div style="display:block;width:24;height:24;overflow:hidden;'+smbl[0]+';position:relative;left:'+(this.width/2-12)+';top:'+(this.height/2-12)+';font-weight:bold;color:white;text-align:center;padding: 1px;">&nbsp;' + smbl[1] + '&nbsp;</div>';
